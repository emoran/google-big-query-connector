...
public class TruncateTableMessageProcessorDebuggable
    extends TruncateTableMessageProcessor
    implements DebugInfoProvider
{


    public TruncateTableMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("dataSetName", "Data set name", (java.lang.String.class), dataSetName, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("projectName", "Project name", (java.lang.String.class), projectName, muleEvent));
