    ...
    implements DebugInfoProvider
{
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("jsonSchema", "Json schema", (java.lang.String.class), jsonSchema, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("datasetName", "Dataset name", (java.lang.String.class), datasetName, muleEvent));
