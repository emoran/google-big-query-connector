...
/**
 * QueryMessageProcessor invokes the {@link org.mule.modules.googlebigquery.GoogleBigQueryConnector#Query(java.lang.String)} method in {@link GoogleBigQueryConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
        ...
        try {
            ...
            resultPayload = processTemplate.execute(new ProcessCallback<Object,Object>() {
                ...
                public Object process(Object object)
                    throws Exception
                {
                    return ((GoogleBigQueryConnector) object).Query(_transformedQueryString);
                }
        ...
        try {
            ...
            try {
                ...
                if (metadata.get() == null) {
                    return new DefaultResult<MetaData>(null, (Result.Status.FAILURE), "There was an error processing metadata at GoogleBigQueryConnector at Query retrieving was successful but result is null");
                }
                return metadata;
            } catch (Exception e) {
